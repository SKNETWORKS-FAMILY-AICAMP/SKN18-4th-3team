...
def extract_emotion_keywords(text: str, sentiment_type: str = None) -> List[str]:
    ...
    emotion_keywords = {
        ...
        'negative': [
            ...
            '충격', '공포', '무서움', '겁', '긴장', '초조', '조급', '억울', '힘든', '슬픈', '우울한'
        ]
    }
...
DISEASE_NORMALIZATION_MAP = {
    ...
    '신체증상장애': '신체증상장애', '월경전불쾌감증상': '월경전불쾌감증상','월경 전 불쾌감 증상': '월경전불쾌감증상',
    '자살': '자살', '자살과 자살예방': '자살',
}
